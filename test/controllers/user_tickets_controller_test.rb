...
class UserTicketsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_ticket" do
    assert_difference("UserTicket.count") do
      post user_tickets_url, params: { user_ticket: { ticket_id: @user_ticket.ticket_id, user_id: @user_ticket.user_id } }
    end
  ...
  test "should update user_ticket" do
    patch user_ticket_url(@user_ticket), params: { user_ticket: { ticket_id: @user_ticket.ticket_id, user_id: @user_ticket.user_id } }
